...
function camera.firstPersonMovement(dt)
    ...
    local speed = 9
    if love.keyboard.isDown (love.keyboard.getScancodeFromKey("w")) then moveX = moveX + 1 end
    if love.keyboard.isDown (love.keyboard.getScancodeFromKey("a")) then moveY = moveY + 1 end
    if love.keyboard.isDown (love.keyboard.getScancodeFromKey("s")) then moveX = moveX - 1 end
    if love.keyboard.isDown (love.keyboard.getScancodeFromKey("d")) then moveY = moveY - 1 end

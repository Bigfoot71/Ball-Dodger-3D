...
function player:new(x,y,z)
    ...
    self.model = {
        g3d.newModel("assets/models/cube.obj", "assets/textures/tx_player.jpg",self.position[1], nil, nil),
        g3d.newModel("assets/models/cube.obj", "assets/textures/tx_player.jpg",self.position[2], nil, nil)
    }
...
function player:move(dx,onPress)

...
function obstacle:new(x,y,z)
    ...
    self.model = g3d.newModel("assets/models/sphere.obj", "assets/textures/basket-ball_512x512.png",self.position, nil, .85)
...
function obstacle:deactive(collidePlayer)
    ...
    -- Reinit des valeurs
    self.timer = 0
    self.timerLimit = math.random(.75,1.75)
    self.speed = math.random(22,25)
    self.active[1] = false
